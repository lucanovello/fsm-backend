...
export function applyTagMetadata(openapi: Record<string, unknown>): void {
  openapi.tags = [
    ...
    { name: Tags.ServiceResources, description: "Service resource directory and profiles." },
    { name: Tags.Crews, description: "Crew definitions and membership management." },
    { name: Tags.Scheduling, description: "Bookings and routing operations." },

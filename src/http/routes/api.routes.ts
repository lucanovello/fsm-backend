...
import { serviceLocationsRoutes } from "../../modules/service-locations/serviceLocations.routes.js";
import { serviceResourcesRoutes } from "../../modules/service-resources/serviceResources.routes.js";
import { resourceSkillsRoutes } from "../../modules/skills/resourceSkills.routes.js";
...
apiRoutes.use("/service-locations", serviceLocationsRoutes);
apiRoutes.use("/service-resources", serviceResourcesRoutes);
apiRoutes.use("/service-resources", resourceSkillsRoutes);
apiRoutes.use("/skills", skillsRoutes);
